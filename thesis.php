      ...
      <div class="span10">
        ...
        <section id="Introduction">
            <div class="page-header">
            	...
            	<p>You're already checking in to places via social media, and your friends do to.  Its a great way to keep track of the cool places you've been to, and to keep tabs on what your friends are doing.  </p>
            	<p>What if you could use that data as a baseline, to help predict the types of places you might like based on shared experiences between you and your friends?</p>
