...
<body>
    ...
    <header class="jumbotron subhead" id="overview">
      <div class="container">
        <h1>Social Media Aggregation</h1>
      </div>
    </header>
      ...
      <div class="span10">
        ...
        <section id="Introduction">
            <div class="page-header">
                <h5>You (and your friends) already checkin to places.  Pool those shared connections to create place recommendations in the future!</h5>
            </div>
            
          <h3>Link accounts where you checkin</h3>
                
				   <p><a href="facebook/index.php" class="btn btn-facebook"><i class="fa fa-facebook"></i> | Connect with Facebook</a></p>
				   <p><a href="foursquare/index.php" class="btn btn-foursquare"><i class="fa fa-foursquare"></i> | Connect with Foursquare</a></p>
				   <p><a href="instagram/index.php" class="btn btn-instagram"><i class="fa fa-camera-retro"></i> | Connect with Instagram</a></p>
				   <p><a href="#" class="btn btn-google-plus "><i class="fa fa-google-plus"></i> | Connect with Google Plus</a></p>
